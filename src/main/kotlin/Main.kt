fun main(args: Array<String>) {
    ...
    while (accounttype == "") {      //Loop until user choose correct account type
    ...
    println("Your account type is $accounttype")
    var accountBalance = (0..10000).random()
    println("Your BALANCE = $accountBalance")
    ...
    fun debitWithdraw(amount: Int): Int {
        if (accountBalance <= 0) {
            println("Withdraw Error You don`t have enough money")
